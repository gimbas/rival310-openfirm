# App Config
ARM_LIBROOT ?= /opt/arm/
DEVICEDIR = $(ARM_LIBROOT)/Keil.STM32F1xx_DFP.2.3.0/Device/Include
COREDIR = $(ARM_LIBROOT)/ARM.CMSIS.5.5.1/CMSIS/Include
MCU_TYPE = STM32F10X_HD
...
## Linker scripts
LDSCRIPT = ld/stm32f103rc_app.ld
...
.PHONY: clean clean-bin make-dir mem-usage version dec-version inc-version reset erase flash debug compile all
